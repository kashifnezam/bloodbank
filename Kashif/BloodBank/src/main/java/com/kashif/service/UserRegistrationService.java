...
public class UserRegistrationService {
    ...
    public RegistrationDTO registerUser(RegistrationDTO registrationDTO) {
        ...
        // Profile PICture
        userRegistration.setProfilePicURL(registrationDTO.getProfilePicURL());
    ...
    public Page<UserRegistration> getAllUsersForDataTables(int page, int length) {
    ...
    public void updateWrongAttempts(int wrongAttempts, String username) {
        updateQuery.updateWrongAttemptsByUsername(wrongAttempts, username);
    }
    ...
    public void updateCoins(String username, Long coins) {
        ...
        updateQuery.updateCoins(username, coins);
    }
