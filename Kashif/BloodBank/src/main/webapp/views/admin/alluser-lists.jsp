    ...
    <main class="content">
        ...
        <div class="action-buttons">
            ...
            <form action="/dashboard/alluser-lists" method="post">
                ...
                <input type="text" id="startDate" name="startDate" placeholder="Start Date" style="display: none;">
                <input type="text" id="endDate" name="endDate" placeholder="End Date" style="display: none;">
                <button type="submit">Filter</button>
            </form>
        
        </div>
        <div class="enduser-list">
<!--            <table id="alluser-list">-->
<!--            -->
<!--            </table >-->
            <table id="alluser-list">
                <thead>
