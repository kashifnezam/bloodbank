    ...
    <body>
        <form action="/registration" method="post" id="signupForm">
            <div class="signup-container">
                ...
                <!-- New input field for profile picture URL -->
                <input type="url" id="profilePic" name="profilePicURL" placeholder="Profile Picture URL"
                       title="Save your profile picture on a cloud storage service like Google Drive, Dropbox, etc.,
